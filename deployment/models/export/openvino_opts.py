...
from deployment.models.export.common import Precision


class OpenVINOConfig(BaseModel):
    precision: Literal[Precision.FP16, Precision.FP32, Precision.INT8] = Field(
        default=Precision.FP32, description="Perform a set of optimization passes to optimize a model for the "
