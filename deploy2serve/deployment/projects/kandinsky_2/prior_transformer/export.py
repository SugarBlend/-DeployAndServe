...
from deploy2serve.deployment.projects.kandinsky_2.prior_transformer.batcher import PriorTransformerBatcher
...
class OverrideONNX(ONNXExporter):
    def register_batcher(self) -> Optional[BaseBatcher]:
        return PriorTransformerBatcher(self.config, "kandinsky-prior_transformer", 1)
